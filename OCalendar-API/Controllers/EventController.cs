...
public class EventController : ControllerBase
{
    ...
    [HttpPost("")]
    public ActionResult<Event> Create([FromBody] EventDto eventDto)
    {
        return Ok(_eventService.Create(eventDto));
    }
    ...
    [TypeFilter(typeof(CanManageFilter), Arguments = new object[] { eManageOptions.ManageEvents })]
    [HttpPut("{id:int}")]
    public ActionResult<Event> Update(int id, [FromBody] EventDto eventDto)
    {
        Event? eventSucces = _eventService.Update(id, eventDto);
